...
export const POCKET_TTS_HF_BUNDLE_BASE = getReadAloudConfig().hfBundleBase;

/** Public path prefix — must match bundleProxyPrefix in config.ts */
export const POCKET_TTS_PROXY_PREFIX = getReadAloudConfig().bundleProxyPrefix;
