...
import { POCKET_TTS_DEFAULT_LANGUAGE } from './pocket-tts';
import { ttsMark } from './pocket-tts-timeline';

/** Same-origin Worker proxy — avoids Hugging Face CORS in the browser. */
export const POCKET_TTS_BUNDLE_BASE = getReadAloudConfig().bundleProxyPrefix;

/** Cache API bucket name for ONNX bundle assets. */
export const POCKET_TTS_MODEL_CACHE_NAME = getReadAloudConfig().modelCacheName;
